<template>
  <div
    ...
    <section
      class="relative z-30 flex flex-col items-center justify-center w-full max-w-screen-lg gap-20 px-6 py-10 mx-auto md:justify-between md:px-10 md:py-40 md:flex-row xl:max-w-screen-xl">
