<template>
  <div>
    <header :class="[
      ...
      <div class="flex items-center justify-between w-full max-w-screen-lg px-6 md:px-10 xl:max-w-screen-xl">
        ...
        <div class="block w-8 h-8 cursor-pointer md:hidden" @click="toggleMenu">
          <Burger />
        </div>
      </div>
    </header>
