<template>
  <div class="w-full overflow-hidden max-h-[778px] py-10">
    <section class="relative flex flex-col items-center justify-center w-full mx-auto max-h-[778px]">
      ...
      <p
        class="font-ag font-semibold uppercase absolute bottom-[90px] text-grad text-center w-full text-[45px] sm:text-[60px] lg:text-[80px] xl:text-[110px] leading-none z-40">
        Tickets
        sold
      </p>
    </section>
